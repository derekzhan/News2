...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="网易新闻",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12网易新闻11AppDelegate")
...
SWIFT_CLASS("_TtC12网易新闻18HomeViewController")
...
@interface HomeViewController (SWIFT_EXTENSION(网易新闻)) <UITableViewDataSource>
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC12网易新闻8NewsMode")
@interface NewsMode : NSObject
@property (nonatomic) NSInteger replyCount;
@property (nonatomic, copy) NSString * _Nonnull title;
@property (nonatomic, copy) NSString * _Nonnull source;
@property (nonatomic, copy) NSString * _Nonnull imgsrc;
...
SWIFT_CLASS("_TtC12网易新闻12NewsViewCell")
@interface NewsViewCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified source;
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified replyCount;
...
SWIFT_CLASS("_TtC12网易新闻13SceneDelegate")
...
SWIFT_CLASS("_TtC12网易新闻14ViewController")
